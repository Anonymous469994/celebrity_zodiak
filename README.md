...
- Чаще всего в кино идут представители стихии огня. Об этом и говорит астрологическая теория.
...
Я сейчас взял 4 рандомных факта из моего мини-исследования. Внутри фактов еще больше и много картинок. В файле 3_DM_EDA.ipynb. Остальные файлы нужны лишь для верификации полученных выводов. Читайте, и оставляйте, пожалуйста, комментарии на почту.

Больше всего меня интересует мнение скептиков. Я очень внимательно подходил к верифицируемости данных. Поэтому все эксперименты можно повторить, если будет желание. Если будут вопросы как именно это сделать - пишите на почту. Но, скорее всего, все должно заработать если просто последовательно запускать код. Хотя, кинопоиск время от времени меняет интерфейс. Если что-то не работает, то, скорее всего, по этой причине.

Я предпочитаю думать, что дело в том, что люди (особенно актеры) просто очень суеверны. Но другое мнение - мнение, что звезды на что-то влияют я тоже рассматриваю как равноправную гипотезу. Возможно, я более подробно опишу свои взгляды в другой статье позже. Но из того, что я вольнодумно отношусь к астрологии не следует, что я защищаю астрологию. Я ***не** защищаю* астрологию.
...
3. 3_DM_EDA.ipynb — exploratory data analysis & data mining; *самая красивая часть с рисунками и прочем*
4. 4_statistical_analysis.ipynb - проверка гипотез (пока еще околочерновой вариант)
5. **summary.pdf** - специально для сверхлюдей у которых не открывались документы .ipynb я сделал отдельный файл с кратким изложением этих файлов
5. data — папка с данными, которые я исследовал; я загружал данные итерационно (всего в 66 итерации) поэтому в папке 2 файла: последняя итерация и файл с суммой всех итераций
6. my_zodiac_library.py — мой модуль с функциями, которые я использую в 3_DM_EDA.ipynb. Вынес в отдельный файл, чтобы улучшить восприятие
